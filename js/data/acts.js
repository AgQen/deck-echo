...
export const ACTS = {
  1: {
    ...
    typeWeights: { battle: 60, event: 15, shop: 8, rest: 10, elite: 7 },
  ...
  2: {
    ...
    typeWeights: { battle: 50, event: 15, shop: 10, rest: 10, elite: 15 },
  ...
  3: {
    ...
    typeWeights: { battle: 45, event: 10, shop: 10, rest: 10, elite: 25 },
